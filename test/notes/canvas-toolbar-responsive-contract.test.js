...
function readResponsiveMediaBlock(styles, mediaQuery) {
...
function readGapValues(ruleBody) {
...
test("Drawing tools render visible labels and retain accessible names", () => {
  ...
  assert.match(eraseActiveRule[1], /background:\s*rgb\(164 72 72 \/ 13%\);/);
