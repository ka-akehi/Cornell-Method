/* eslint-disable @typescript-eslint/no-require-imports -- focused Node shell contract tests */
...
function taskBody({ impact, reversibility, verification, flags, extra = "" }) {
  return [
    "# Worker Task",
    "",
