...
} from "@/shared/canvas/canvas-history";
import {
...
} from "../_lib/canvas-editor-document";
import {
  INITIAL_STYLE_DEFAULTS,
  getDrawingStyleTarget,
  isCanvasTextAlign,
  isColorInputValue,
} from "../_lib/canvas-editor-style";
import { useNoteCanvasRuntime } from "../_lib/use-note-canvas-runtime";
