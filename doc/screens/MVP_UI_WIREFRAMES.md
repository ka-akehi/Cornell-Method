...
- 操作ボタンは折り返し可能な横並びにする。
- Cornell レイアウトは Cue、本文、サマリーの順に 1 カラムで表示する。
...
![NTE-030 ノート詳細 復習モードの視覚ワイヤフレーム](assets/mockups/mvp-nte-030-note-detail-review-wireframe.png)
...
+------------------------------------------------------------------+
| ノートタイトル                                                   |
| 学習日 2026-07-01  [tag] [tag]                                   |
| 次回復習日 [2026-07-10]  最終復習日 2026-07-02                   |
+------------------------------------------------------------------+
| Recall Area                                                      |
| +------------------------------+ +-----------------------------+ |
| | Cue / キーワード / 質問      | | 本文                         | |
...
本文表示後は、同じ本文エリア内で Markdown 表示と `[本文を隠す]` を表示します。

### モバイルの積み順 / 折り返し方針

- タイトルとメタ情報の次に Cue を置く。
- サマリーを Cue の直後に置き、想起の手がかりを本文より先に提示する。
- 本文エリアは初期非表示のまま、その位置に「本文を表示」操作を置く。
- 復習記録は最下部に置く。
